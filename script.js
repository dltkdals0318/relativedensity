...
const workData = {
  ...
  3: { title: "title 18", description: "작품 설명 18" },
  ...
  7: { title: "title 13", description: "작품 설명 13" },
  8: { title: "title 32", description: "작품 설명 32" },
  ...
  10: { title: "title 14", description: "작품 설명 14" },
  ...
  12: { title: "title 17", description: "작품 설명 17" },
  ...
  18: { title: "title 19", description: "작품 설명 19" },
  ...
  21: { title: "title 12", description: "작품 설명 12" },
  ...
  25: { title: "title 25", description: "작품 설명 25" },
  26: { title: "title 23", description: "작품 설명 23" },
  27: { title: "RgbDelay", description: "TouchDesigner 툴을 공부하기 위한 습작. RGB 색상층의 이동을 분리하는 RgbDelay 기능을 중심으로 이용해 방사형 그래픽을 생성했다." },
  28: { title: "title 20", description: "작품 설명 20" },
  ...
  36: { title: "title 21", description: "작품 설명 21" },
  37: { title: "title 16", description: "작품 설명 16" },
  ...
  40: { title: "title 24", description: "작품 설명 24" }
};
